...
ngOnInit(): void {
  ...
  ...this.form.value,
  active: this.form.value.active === true || this.form.value.active === 'true'
};
  ...
  if (this.isEditMode) {
    ...
    this.toast.show('Curso agregado con éxito', 'success');
    this.form.reset({ level: this.levels[0], active: true });
  }
}
